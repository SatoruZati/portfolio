...
import {SiReact, SiJavascript, SiTypescript, SiTailwindcss, SiExpress, SiMongodb, SiVite, SiHtml5 } from "react-icons/si";
...
function App(){
  ...
  return (
    <div ref={containerRef} className="flex flex-col m-0 p-0 w-screen min-h-screen bg-black text-white overflow-x-hidden">
      ...
      >
        <div className="flex justify-between items-center mx-8 h-20 font-medium">
          <motion.div 
            whileHover={{ scale: 1.05 }}
            className="relative"
          >
            <h1 className="text-3xl text-white font-bold cyber-text matrix-text tracking-wider">
          ...
          <div className="justify-between flex gap-8">
            <motion.a 
              href="#about"
              whileHover={{ scale: 1.05 }}
              className="text-base text-gray-300 hover:text-white cursor-pointer relative group tracking-wide"
            >
              About
              <motion.div 
                className="absolute -bottom-1 left-0 right-0 h-0.5 bg-blue-500"
          ...
          <div className="justify-between flex gap-4 items-center">
            <motion.button 
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="text-base text-white py-2 px-6 rounded-full bg-blue-500 hover:bg-blue-600 transition-colors shadow-lg shadow-blue-500/20 tracking-wide"
            >
              Get in Touch
            </motion.button>
          </div>
      ...
      <div className="h-screen flex items-center justify-center relative overflow-hidden">
        ...
        >
          ...
          >
            <motion.img 
              src={pfp} 
              className="w-40 h-40 rounded-full mx-auto mb-8 border-4 border-blue-500/30 shadow-lg shadow-blue-500/20"
              whileHover={{ scale: 1.05 }}
              transition={{ type: "spring", stiffness: 300 }}
            />
          </motion.div>
          <motion.h1 
            className="text-7xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500 animate-gradient tracking-tight"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <motion.p 
            className="text-2xl text-gray-300 mb-8 tracking-wide"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <a href="#projects" className="text-blue-400 hover:text-blue-300 text-lg flex items-center gap-2 group">
              View My Work 
      ...
      {/* Projects Grid */}
      <div 
        className="min-h-screen py-20 px-8 relative z-10 bg-black/80 backdrop-blur-sm"
        ref={(el) => {
          if (el) {
      ...
      {/* Skills Section */}
      <div className="min-h-screen py-20 px-8 bg-black/80 backdrop-blur-sm relative z-10">
        <motion.div 
          className="absolute inset-0 z-0 overflow-hidden"
          initial={{ opacity: 0.5 }}
          whileHover={{ opacity: 0.8 }}
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <motion.h2 
            className="text-5xl font-bold text-center mb-12 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500 animate-gradient tracking-tight"
            initial={{ opacity: 0, y: 20 }}
      ...
      {/* Footer */}
      <footer className="py-8 px-8 border-t border-gray-800 relative z-10 bg-black/90">
        <div className="max-w-7xl mx-auto text-center text-gray-400">
          <p className="mb-2 tracking-wide">Made with ❤️ by 
          ...
          <p className="text-sm tracking-wide">© 2024 All rights reserved</p>
        </div>
      </footer>
    </div>
  );
